...
<div className='col-xl-6 col-lg-7'>
              <div className='about-three__content-box'>
                <div className='sec-title'>
                <h2 className='sec-title__title'><br/>
                    Our Mission
                  </h2>
                </div>
                <div className='about-three__content-box-inner'>
...
<div className='col-xl-6 col-lg-5 text-center'><img src="assets/images/founderimg.png" /><h5>Vikas Kabra</h5><h6>Co-Founder</h6></div>
