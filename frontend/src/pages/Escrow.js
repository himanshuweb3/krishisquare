  ...
  <div className="col-xl-4 col-md-6 col-12">
    <div className="lab-item">
      <div className="lab-inner">
        <div className="lab-thumb"><img src="assets\images\services\01.png" alt="lab-thumb" /></div>
<div className="lab-content"><button className="lab-btn btn-sm text-white">Step 1</button><br /><br /><a href="/escrow">
<h5>Send Agreement</h5></a><p>Provide transaction details and send an agreement with terms and conditions to buyer and seller</p>
</div></div></div></div>
  
  <div className="col-xl-4 col-md-6 col-12">
    <div className="lab-item">
      <div className="lab-inner">
        <div className="lab-thumb"><img src="assets\images\services\02.png" alt="lab-thumb" /></div>
<div className="lab-content"><button className="lab-btn btn-sm text-white">Step 2</button><br /><br /><a href="/escrow">
<h5>Accept Terms and Conditions</h5></a><p>Buyer and seller to agree on terms and conditions on product quantity, price, quality, shipping information and payment release condition</p>
</div></div></div></div>
  
  <div className="col-xl-4 col-md-6 col-12"><div className="lab-item"><div className="lab-inner">
    <div className="lab-thumb"><img src="assets\images\services\03.png" alt="lab-thumb" /></div>
<div className="lab-content"><button className="lab-btn btn-sm text-white">Step 3</button><br /><br /><a href="/escrow">
      <h5>Transfer Payment to Escrow</h5></a><p>Buyer to transfer the invoice amount to escrow account, where funds will be parked until the order is fulfilled</p>
</div></div></div></div>

  <div className="col-xl-4 col-md-6 col-12"><div className="lab-item"><div className="lab-inner">
    <div className="lab-thumb"><img src="assets\images\services\04.png" alt="lab-thumb" /></div>
<div className="lab-content"><button className="lab-btn btn-sm text-white">Step 4</button><br /><br /><a href="/escrow"><h5>Provide Document Proof</h5></a><p>Seller to provide proof of shipment for goods Inspection period</p>
</div></div></div></div>
  
  <div className="col-xl-4 col-md-6 col-12"><div className="lab-item"><div className="lab-inner">
    <div className="lab-thumb"><img src="assets\images\services\05.png" alt="lab-thumb" /></div>
<div className="lab-content"><button className="lab-btn btn-sm text-white">Step 5</button><br /><br /><a href="/escrow"><h5>Inspection Period</h5></a><p>On receipt of goods, buyer gets a inspection period during which they give a go ahead if the quality is fine else sent back to seller</p>
</div></div></div></div>
  
  <div className="col-xl-4 col-md-6 col-12"><div className="lab-item"><div className="lab-inner">
    <div className="lab-thumb"><img src="assets\images\services\06.png" alt="lab-thumb" /></div>
<div className="lab-content"><button className="lab-btn btn-sm text-white">Step 6</button><br /><br /><a href="/escrow"><h5>Document verification</h5></a><p>Documents to be checked against agreement for payment release if the quality is fine by buyer</p>
</div></div></div></div>
  
  <div className="col-xl-4 col-md-6 col-12"><div className="lab-item"><div className="lab-inner">
    <div className="lab-thumb"><img src="assets\images\services\01.png" alt="lab-thumb" /></div>
<div className="lab-content"><button className="lab-btn btn-sm text-white">Step 7</button><br /><br /><a href="/escrow"><h5>Payment Release</h5></a><p>Once documents are verified, payment will be released and seller will receive funds within 48 hours</p>
</div></div></div></div>
