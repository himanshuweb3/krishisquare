...
<div class="row justify-content-center">
  <div class="col-xl-4 col-md-6 col-12">
    <div class="lab-item">
      <div class="lab-inner">
        <div class="lab-thumb"><img src="assets\images\service\01.png" alt="lab-thumb" /></div>
<div class="lab-content"><button class="lab-btn btn-sm text-white">Step 1</button><br><br><a href="/escrow">
<h5>Send Agreement</h5></a><br><p>Provide transaction details and send an agreement with terms and conditions to buyer and seller</p>
  ...
  <div class="col-xl-4 col-md-6 col-12">
    <div class="lab-item">
      <div class="lab-inner">
        <div class="lab-thumb"><img src="assets\images\service\02.png" alt="lab-thumb" /></div>
<div class="lab-content"><button class="lab-btn btn-sm text-white">Step 2</button><br><br><a href="/escrow">
<h5>Accept Terms and Conditions</h5></a><br><p>Buyer and seller to agree on terms and conditions on product quantity, price, quality, shipping information and payment release condition</p>
  ...
  <div class="col-xl-4 col-md-6 col-12"><div class="lab-item"><div class="lab-inner">
    <div class="lab-thumb"><img src="assets\images\service\03.png" alt="lab-thumb" /></div>
<div class="lab-content"><button class="lab-btn btn-sm text-white">Step 3</button><br><br><a href="/escrow">
  ...
  <div class="col-xl-4 col-md-6 col-12"><div class="lab-item"><div class="lab-inner">
    <div class="lab-thumb"><img src="assets\images\service\04.png" alt="lab-thumb" /></div>
<div class="lab-content"><button class="lab-btn btn-sm text-white">Step 4</button><br><br><a href="/escrow"><h5>Provide Document Proof</h5></a><br><p>Seller to provide proof of shipment for goods Inspection period</p>
</div></div></div></div>
  
  <div class="col-xl-4 col-md-6 col-12"><div class="lab-item"><div class="lab-inner">
    <div class="lab-thumb"><img src="assets\images\service\05.png" alt="lab-thumb" /></div>
<div class="lab-content"><button class="lab-btn btn-sm text-white">Step 5</button><br><br><a href="/escrow"><h5>Inspection Period</h5></a><br><p>On receipt of goods, buyer gets a inspection period during which they give a go ahead if the quality is fine else sent back to seller</p>
</div></div></div></div>
  
  <div class="col-xl-4 col-md-6 col-12"><div class="lab-item"><div class="lab-inner">
    <div class="lab-thumb"><img src="assets\images\service\06.png" alt="lab-thumb" /></div>
<div class="lab-content"><button class="lab-btn btn-sm text-white">Step 6</button><br><br><a href="/escrow"><h5>Document verification</h5></a><br><p>Documents to be checked against agreement for payment release if the quality is fine by buyer</p>
</div></div></div></div>
  
  <div class="col-xl-4 col-md-6 col-12"><div class="lab-item"><div class="lab-inner">
    <div class="lab-thumb"><img src="assets\images\service\01.png" alt="lab-thumb" /></div>
<div class="lab-content"><button class="lab-btn btn-sm text-white">Step 7</button><br><br><a href="/escrow"><h5>Payment Release</h5></a><br><p>Once documents are verified, payment will be released and seller will receive funds within 48 hours</p>
</div></div></div></div>
