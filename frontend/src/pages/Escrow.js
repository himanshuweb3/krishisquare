...
<div className="lab-content"><button className="lab-btn btn-sm text-white">Step 4</button><br /><br /><Link to="/escrow"><h5>Provide Document Proof</h5></a><br /><p>Seller to provide proof of shipment for goods Inspection period</p>
</div></div></div></div>
...
<div className="lab-content"><button className="lab-btn btn-sm text-white">Step 5</button><br /><br /><Link to="/escrow"><h5>Inspection Period</h5></a><br /><p>On receipt of goods, buyer gets a inspection period during which they give a go ahead if the quality is fine else sent back to seller</p>
</div></div></div></div>
  
  <div className="col-xl-4 col-md-6 col-12"><div className="lab-item"><div className="lab-inner">
    <div className="lab-thumb"><img src="assets\images\service\06.png" alt="lab-thumb" /></div>
<div className="lab-content"><button className="lab-btn btn-sm text-white">Step 6</button><br /><br /><Link to="/escrow"><h5>Document verification</h5></a><br /><p>Documents to be checked against agreement for payment release if the quality is fine by buyer</p>
</div></div></div></div>
  
  <div className="col-xl-4 col-md-6 col-12"><div className="lab-item"><div className="lab-inner">
    <div className="lab-thumb"><img src="assets\images\service\01.png" alt="lab-thumb" /></div>
<div className="lab-content"><button className="lab-btn btn-sm text-white">Step 7</button><br /><br /><Link to="/escrow"><h5>Payment Release</h5></a><br /><p>Once documents are verified, payment will be released and seller will receive funds within 48 hours</p>
</div></div></div></div>
